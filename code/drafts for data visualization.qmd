...
```{r}
#| label: salinity-time-series

sitesalinity_directlabel <- ggplot(data = salinity_prcp,
                                # x-axis: survey date
                                # y-axis: total counts
  ...
  geom_text_repel(
    ...
    segment.size = 0.5,
    force = 0.5,
    xlim  = as_date("2021-01-01"),
    show.legend = FALSE) +
  geom_vline(xintercept = as_date("2024-01-01"),
             linetype = "dashed") +
  draw_label("Major rain event\n(3.40 in)",
