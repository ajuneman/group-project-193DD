...
*Figure 2. This figure displays the relationship between monthly average water surface elevation and monthly average salinity as maroon points. Data from @rickard2024.*
...
*Figure 3. This figure displays the relationship between the monthly average temperature in degrees Fahrenheit and monthly average salinity for each of the three sites of interest (Phelps Bridge, East Channel, Venoco Bridge). Data from @rickard2024.*
...
*Figure 4. This figure displays the relationship between the monthly total precipitation in inches and the monthly average salinity in ppt. The figure is divided and colored by observations from each of the three sites of interest (Phelps Bridge, East Channel, and Venoco Bridge). Data from @rickard2024.*
